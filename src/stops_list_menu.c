...
static void draw_row_callback(GContext *ctx, Layer *cell_layer, MenuIndex *cell_index, void *context) {
  ...
  snprintf(s_buff, sizeof(s_buff), "Stop %d", (int)cell_index->row);
...
static void window_load(Window *window) {
  ...
  s_menu_layer = menu_layer_create(GRect(0, 168 - LIST_MESSAGE_WINDOW_MENU_HEIGHT, 144, LIST_MESSAGE_WINDOW_MENU_HEIGHT));
  ...
  s_list_message_layer = text_layer_create(GRect(0, 0, 144, 168 - LIST_MESSAGE_WINDOW_MENU_HEIGHT));
